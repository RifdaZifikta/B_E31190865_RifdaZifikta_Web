...
<h1 class="h4 text-gray-900 mb-4">Tambah User</h1></div> <!--berfungsi memberikan judul tabel-->
...
<input type="submit" class="btn btn-success btn-icon-split" name="submit" value="Tambah"><!--berfungsi untuk menambahkan sebuah button-->
</form><hr> 
<div class="text-center"> 
